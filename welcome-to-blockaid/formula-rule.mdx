...
\> The contract (for Contract Call type) or Sui object (for Object Read type) must already exist in your [Inventory](https://docs.blockaid.io/docs/inventory#/) as an asset before you can configure and save the metric.
...
\*\*Note:\*\* If the Functions list is empty, the contract you've selected doesn't include functions that return numeric values. To continue, select a different contract.
...
5. Once the test passed successfully, click \*\*Save Metric\*\*.
   ...
   \<Image align="left" width="550px" src="https://files.readme.io/7377d5fb17dbb39de0fcdfda17070116be8a707027741ccfebf7d8f26b860791-configure_metric.gif" /\>
